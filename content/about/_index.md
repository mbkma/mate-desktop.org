...
- **Translate** - Help make MATE available in more languages
- **Code** - Contribute patches and new features
- **Documentation** - Help improve our docs
- **Artwork** - Create themes, icons, and wallpapers
- **Support** - Help other users in forums and chat

Visit our [GitHub organization](https://github.com/mate-desktop) to get started.
